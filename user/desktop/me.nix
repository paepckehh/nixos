{pkgs, ...}: {
  ...
  home-manager.users.me = {
    home = {
      ...
      file.".face".source = ../../shared/brand/deb.jpg;
    };
    xdg = {
      autostart = {
        enable = true;
    ...
    dconf = {
      ...
      settings = {
        "org/gnome/shell" = {
          ...
          favorite-apps = ["Alacritty.desktop" "com.mitchellh.ghostty.desktop" "kitty.desktop" "dss.desktop" "firefox.desktop" "librewolf.desktop" "org.keepassxc.KeePassXC.desktop" "org.gnome.Nautilus.desktop" "element-desktop.desktop" "onlyoffice-desktopeditors.desktop"];
        };
