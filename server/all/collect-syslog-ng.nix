{
  ...
  #####################
  environment = {
    shellAliases."console" = ''sudo tail -n 2500 -f /var/syslog-ng/console.txt |  bat --force-colorization --language syslog --paging never'';
    shellAliases."console.all" = ''sudo tail -n 2500 -f /var/syslog-ng/console-all.txt |  bat --force-colorization --language syslog --paging never'';
    shellAliases."console.err" = ''sudo tail -n 2500 -f /var/syslog-ng/console-err.txt |  bat --force-colorization --language syslog --paging never'';
    shellAliases."console.crit" = ''sudo tail -n 2500 -f /var/syslog-ng/console-crit.txt |  bat --force-colorization --language syslog --paging never'';
  };
