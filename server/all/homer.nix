{config, ...}: let
  infra = {
    ...
    namespace = {
      ...
      remote = "${toString infra.id.remote}";
    };
    pki = {
    ...
    portal = {
      ...
      networks = "${infra.cidr.user} ${infra.cidr.admin} ${infra.cidr.remote}";
...
in {
  ...
  services = {
    homer = {
      ...
      settings = {
        title = " ⛅DEBICLOUD";
        subtitle = " ==> Start Portal interne Business Services Cloud!";
        ...
        message = {
          ...
          content = ''
            <form method="post" action="https://suche.dbt.corp/">
        ...
        links = [];
        footer = "<p> 🤘 Einen erfolgreichen Arbeitstag wünscht euer Debitor IT Team 🤘 </p>";
        services = [
          {
            name = "INTERN";
            icon = "fas fa-cloud";
    ...
    caddy = {
      ...
      virtualHosts."${infra.portal.fqdn}".extraConfig = ''
        ...
        @not_intranet {
          not remote_ip ${infra.portal.networks} 
        }
